...
public static class Extensions
{
    ...
    public const string SpreadsheetId = "spreadsheet";
    ...
    public static readonly PackDef Spreadsheet = new(
        SpreadsheetId,
        "Excel・CSV取り込み（表計算ファイル）",
        "Excel（.xlsx）・CSV・TSVファイルをナレッジに取り込めるようにします。表はヘッダ付きのまとまりで検索されます。無効にしても取り込んだファイルは残ります。");
