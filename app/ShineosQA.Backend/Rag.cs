...
public static partial class Rag
{
    ...
    public const string PromptVersion = "2026-09-20-fact-grounding-3"; // プロンプト/キャッシュ仕様変更時は回答キャッシュを無効化
